...
MY_Model::MY_Model(const std::vector<ModelComponent>& components) {
...
void MY_Model::addRange(const std::vector<float>& vertices) {
...
void MY_Model::addModelComponent(const ModelComponent& component) {
    components.push_back(component);
}

const std::vector<ModelComponent>& MY_Model::getModelComponents() const {
    return components;
}
